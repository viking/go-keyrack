...
func TestLogin_PasswordString(t *testing.T) {
  ...
  login, err = NewLogin(1, "Twitter", "dude", "secret", "foo")
  if err != nil {
    t.Fatal(err)
  }
...
func TestLoginList_Len(t *testing.T) {
  ...
  list[0], err = NewLogin(1, "Twitter", "dude", "secret", "foo")
  if err != nil {
    t.Fatal(err)
  }
  if list.Len() != 1 {
...
func TestLoginList_Less(t *testing.T) {
  ...
  list[0], err = NewLogin(1, "Twitter", "dude", "secret", "foo")
  if err == nil {
    list[1], err = NewLogin(2, "Facebook", "foo@example.com", "password", "foo")
  }
  if err == nil {
    list[2], err = NewLogin(3, "Facebook", "bar@example.com", "password", "foo")
  }
  if err == nil {
    list[3], err = NewLogin(4, "Facebook", "bar@example.com", "password", "foo")
  }
  if err != nil {
    t.Fatal(err)
  }
...
func TestLoginList_Swap(t *testing.T) {
  ...
  login_1, err = NewLogin(1, "Twitter", "dude", "secret", "foo")
  if err == nil {
    login_2, err = NewLogin(2, "Facebook", "foo@example.com", "password", "foo")
  }
  if err != nil {
    t.Fatal(err)
  }
